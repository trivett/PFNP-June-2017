...
// please create:
// a variable called `helloWorld`



// a variable called `thisVarHasNumbers111`


// a constant representing the number of months in the year


// 1. create a variable, define it with a string - it should be your first name
